...
public class PlayerMovement : MonoBehaviour {
  ...
  public event Action<bool> OnPlayerIsMovingChange;
  ...
  private void Move() {
    ...
    // Update is moving
    bool newPlayerIsMoving = rb.velocity != Vector2.zero;

    if (playerIsMoving != newPlayerIsMoving) {
      playerIsMoving = newPlayerIsMoving;
      OnPlayerIsMovingChange?.Invoke(playerIsMoving);
    }
